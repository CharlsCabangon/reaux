...
function NavBar() {
  ...
  return (
    <motion.header
      className="fixed left-0 top-0 z-50 w-full bg-off-white/65 px-4 pb-3 pt-4 shadow-md ring-1 ring-white backdrop-blur-sm transition-all sm:px-6 sm:pb-4 sm:pt-5 md:px-8 lg:px-10 lg:pt-6"
